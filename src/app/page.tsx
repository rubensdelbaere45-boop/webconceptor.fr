...
/* ── Data ── */
const sites = [
  { name: "Maison Tete", type: "Restaurant", city: "Lyon", img: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=900&q=80&auto=format&fit=crop", url: "/exemples/maison-tete.html" },
  ...
  { name: "Domaine Ponteves", type: "Vigneron", city: "Provence", img: "https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?w=900&q=80&auto=format&fit=crop", url: "/exemples/domaine-ponteves.html" },
  ...
  { name: "Dr. Lefevre", type: "Medecin", city: "Marseille", img: "https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=900&q=80&auto=format&fit=crop", url: "/exemples/dr-lefevre.html" },
  { name: "L'Atelier Sato", type: "Patisserie", city: "Lyon", img: "https://images.unsplash.com/photo-1587314168485-3236d6710814?w=900&q=80&auto=format&fit=crop", url: "/exemples/atelier-sato.html" },
  { name: "Maison Riviere", type: "Hotel", city: "Nice", img: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=900&q=80&auto=format&fit=crop", url: "/exemples/maison-riviere.html" },
];
...
const sereniteItems = [
  { text: "Mises a jour sur simple email", bold: true },
  { text: "Promos & animations", bold: true },
  { text: "Actualites & horaires", bold: true },
  { text: "Hebergement securise", bold: false },
    ...
    <div className="bg-white text-[#0a0a0a] min-h-screen">
      ...
      >
        <div className="max-w-6xl mx-auto h-14 px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/dashboard/enter-code" className="text-[13px] text-[#737373] hover:text-[#0a0a0a] transition-colors hidden sm:block">
              Mon espace
            </Link>
            <Link href="/demande" className="px-4 py-1.5 bg-[#0a0a0a] text-white text-[13px] font-medium rounded-full hover:bg-[#262626] transition-colors">
              Creer mon site
            </Link>
          </div>
        </div>
      ...
      <section className="min-h-screen flex flex-col items-center justify-center text-center px-6">
        <motion.h1
          ...
          initial="hidden"
          animate="visible"
          className="text-[clamp(3rem,8vw,7rem)] font-extrabold leading-[0.9] tracking-[-0.04em] max-w-3xl"
        >
          {["Sites", "web"].map((w) => (
        ...
        <motion.p
          ...
          className="text-[#a3a3a3] text-lg mt-8 mb-12 max-w-sm"
        >
          Design premium pour les professionnels francais.
        </motion.p>
        ...
        >
          <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
            <Link href="/demande" className="px-8 py-4 bg-[#0a0a0a] text-white text-[15px] font-medium rounded-full hover:bg-[#262626] transition-colors inline-flex items-center gap-2">
              Creer mon site
      ...
      <section className="px-4 sm:px-6 pb-32">
        <motion.div
          ...
          className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-3"
        >
          {sites.map((site) => (
            <motion.a
              key={site.name}
              ...
              className="group relative aspect-[4/3] overflow-hidden rounded-2xl bg-[#f5f5f5]"
            >
              <motion.img
              ...
              {/* Badge */}
              <span className="absolute top-4 right-4 px-2 py-0.5 bg-white/80 backdrop-blur text-[9px] font-bold tracking-widest text-[#0a0a0a] rounded">
                WEBCONCEPTOR
              </span>
            </motion.a>
          ))}
      ...
      {/* ─── TARIF ─── */}
      <section id="tarif" className="px-6 pb-32">
        <motion.div
          variants={stagger(0.15)}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.2 }}
          className="max-w-3xl mx-auto grid md:grid-cols-2 gap-5"
        >
          {/* 599€ */}
          <motion.div variants={scaleIn} whileHover={{ y: -4 }} className="bg-[#0a0a0a] rounded-2xl p-8 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-[12px] text-white/40 mb-1">a partir de</p>
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Link href="/demande" className="block w-full py-3 bg-white text-[#0a0a0a] text-[13px] font-semibold rounded-full text-center">
                  Demander un devis
                </Link>
              </motion.div>
              <p className="text-[11px] text-white/20 text-center mt-3">Sans Formule Serenite, aucune modification apres livraison.</p>
            </div>
          </motion.div>
          ...
          <motion.div
            variants={scaleIn}
            whileHover={{ y: -4, boxShadow: "0 20px 60px -12px rgba(0,102,255,0.12)" }}
            className="bg-white rounded-2xl border-2 border-[#0066ff] p-8 relative overflow-hidden breathe-border"
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-[13px] text-[#0066ff] font-semibold mb-1">Formule Serenite</p>
              ...
              <div className="bg-[#fafafa] rounded-lg p-3 mb-4">
                <p className="text-[12px] text-[#525252]"><span className="font-semibold text-[#0a0a0a]">&ldquo;Un email et c&apos;est a jour dans la journee.&rdquo;</span><br /><span className="text-[#a3a3a3]">— Marie T., Lyon</span></p>
              </div>
      ...
      <section className="px-6 pb-32">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight mb-4">Pret ?</h2>
          <p className="text-[#a3a3a3] mb-8">Decrivez votre projet. Reponse sous 48h.</p>
          <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
            <Link href="/demande" className="px-8 py-4 bg-[#0a0a0a] text-white text-[15px] font-medium rounded-full hover:bg-[#262626] transition-colors inline-block">
              Commencer
            </Link>
          </motion.div>
        </motion.div>
      ...
      <footer className="border-t border-[#f5f5f5] px-6 py-10">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          <p className="text-[13px] text-[#a3a3a3]">&copy; 2026 WebConceptor</p>
          <div className="flex flex-wrap gap-5 text-[12px] text-[#a3a3a3]">
            <Link href="/mentions-legales" className="hover:text-[#0a0a0a] transition-colors">Mentions legales</Link>
            <Link href="/cgu" className="hover:text-[#0a0a0a] transition-colors">CGU</Link>
            <Link href="/confidentialite" className="hover:text-[#0a0a0a] transition-colors">Confidentialite</Link>
