...
function followUpDay3Email(prospectName: string, mockupUrl: string): string {
  ...
  <p style="font-size:14px;color:#525252;margin-bottom:16px"><strong>Pour rappel :</strong> 599 € TTC tout compris, livraison en 5 jours, ou en 3 fois sans frais via Klarna (3 × 199,67 €).</p>
...
function followUpDay7Email(prospectName: string, mockupUrl: string): string {
  ...
  <p style="font-size:14px;color:#525252;margin-bottom:16px">599 € TTC tout compris — 3 fois sans frais via Klarna si besoin.</p>
