...
export const METIER_CONFIGS: MetierConfig[] = [
  {
    key: "traiteur",
    detect: /\b(traiteur|catering|buffet|cuisine.*[ée]v[ée]nement|coeur des saveurs|saveurs|gourmand)/i,
    metierLabel: "Traiteur", metierShort: "TRAITEUR",
    iconNav: "dinner_dining", navCtaText: "DEMANDER UN DEVIS",
    heroBaseline: "Vos événements, sublimés.",
    heroSubtitle: "Traiteur{{CITY_CLAUSE}} — mariages, anniversaires, séminaires. Cuisine artisanale, produits frais, service soigné de A à Z.",
    heroCtaPrimary: "DEMANDER UN DEVIS",
    heroCtaSecondary: "VOIR NOS PRESTATIONS",
    servicesTitle: "Nos prestations",
    services: [
      { icon: "favorite", title: "Mariages", desc: "Buffet, cocktail, dîner assis, vin d'honneur. Menu sur-mesure dégusté avec vous lors d'un essai gratuit." },
      { icon: "celebration", title: "Anniversaires & baptêmes", desc: "Du brunch familial au dîner gastronomique. Service à table ou buffet, vaisselle et nappage compris." },
      { icon: "business_center", title: "Séminaires & cocktails pro", desc: "Plateaux repas, cocktails dînatoires, pauses gourmandes. Livraison sur site, mise en place clé en main." },
      { icon: "kitchen", title: "Livraison à domicile", desc: "Plats frais préparés le matin, livrés sur votre lieu de réception. Service jusqu'à 200 couverts." },
    ],
    footerTagline: "Traiteur artisanal",
    primary: "#3d1a0d", primaryDark: "#1c0a05", accent: "#d97706",
    surface: "#fef8f3", surfaceContainer: "#fde3c2",
  },
  {
    key: "restaurant",
    detect: /\b(restaurant|brasserie|bistro|bistrot|gastronom)/i,
    metierLabel: "Restaurant", metierShort: "RESTAURANT",
    iconNav: "restaurant", navCtaText: "RÉSERVER UNE TABLE",
    heroBaseline: "La table qui vous ressemble.",
    heroSubtitle: "Restaurant{{CITY_CLAUSE}} — cuisine de saison, produits frais, service convivial. Réservation en ligne ou par téléphone.",
    heroCtaPrimary: "RÉSERVER UNE TABLE",
    heroCtaSecondary: "NOTRE CARTE",
    servicesTitle: "Notre cuisine",
    services: [
      { icon: "restaurant_menu", title: "Carte de saison", desc: "Menus renouvelés selon les arrivages. Produits frais, locaux, travaillés avec passion par notre chef." },
      { icon: "wine_bar", title: "Carte des vins", desc: "Sélection de 60 références, vignerons indépendants et grandes appellations. Conseil personnalisé en salle." },
      { icon: "group", title: "Repas de groupe", desc: "Salle privatisable pour anniversaires, repas d'entreprise, mariages intimes. Menu sur-mesure à partir de 8 personnes." },
      { icon: "takeout_dining", title: "À emporter", desc: "Carte à emporter le midi et le soir, commande par téléphone, prête en 20 minutes." },
    ],
    footerTagline: "Restaurant",
    primary: "#7c2d12", primaryDark: "#451a03", accent: "#dc2626",
    surface: "#fef2f2", surfaceContainer: "#fecaca",
  },
  {
    key: "electricien",
